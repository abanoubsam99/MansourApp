...
class SignupTextFild extends StatelessWidget {
   String hint;
   bool secure;
   IconData icon;
  ...
  String _errorMessage(String error) {
    ...
    SignupTextFild({@required this.textEditingController,@required this.hint,@required this.secure,@required this.icon, @required this.textInputType,@required this.onclick});
